...
char wristband_team_and_color[] = "blue-1"; // this should be changed for each sending wristband - checks to see if the right color tag was touched before sending
